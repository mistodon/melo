...
// TODO(claire): Could do this in parsing
...
fn normalize_bar_lengths(parse_tree: &mut ParseTree) -> bool
{
    for piece in &mut parse_tree.pieces
    {
        ...
        // TODO(claire): Technically could do this in parse_play
        for play in &mut piece.plays
        {
        ...
        let min_bar_len = {
            // TODO(claire): This should really be the LCM of max_bar_len and piece.beats
...
mod tests
{
    ...
    // TODO(claire): Finish writing tests for this
}
